...
import HRUserCertificateForm from "./HRCertificateForm";

// Main Functional Component
function HRUserCertificate() {
  // State Declarations
  ...
  useEffect(() => {
    ...
    const fetchCertificates = async () => {
      ...
      if (currentUser) {
        const userDocRef = doc(db, "HRUsers", currentUser.uid);
...
export default HRUserCertificate;
