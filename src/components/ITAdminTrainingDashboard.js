...
import ITAdminTrainingDashboardForm from "./ITAdminTrainingDashboardForm"; // Import the form component

function ITAdminTrainingDashboard() {
...
export default ITAdminTrainingDashboard;
