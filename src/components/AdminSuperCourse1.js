...
import AdminSuperCourseForm1 from "./AdminSuperCourseForm1.jsx"; // Import the form

function AdminSuperCourse1() {
...
export default AdminSuperCourse1;
